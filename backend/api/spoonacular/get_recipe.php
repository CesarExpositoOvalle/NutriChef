...
$url = "https://api.spoonacular.com/recipes/$id/information?includeNutrition=true&apiKey=" . urlencode($apiKey);
...
$data["computedMacros"] = extractMacrosFromNutrition($data["nutrition"] ?? []);
